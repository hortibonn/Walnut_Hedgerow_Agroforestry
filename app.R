  ...
  sidebarLayout(
    ...
    mainPanel(width = 8,
              ...
              tags$h6(
                ...
                tags$a(href = "mailto:mjimene1@uni-bonn.de", "Marcos Jiménez Martínez"), "or", tags$a(href = "mailto:pkasargo@uni-bonn.de", "Prajna Kasargodu Anebagilu"), "or", tags$a(href = "mailto:afuelle1@uni-bonn.de", "Adrian Fuelle."),
